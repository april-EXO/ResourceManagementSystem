    ...
    <div class="card">
        <div class="card-body">
            ...
            <ul class="nav nav-pills mb-5">
                ...
                <li class="nav-item">
                  <a class="nav-link active" href="/admin/rejected">Rejected</a>
                </li>
                <li class="nav-item">
            ...
            <div class="card" style="background-color:rgb(232, 160, 160)">
                <div class="card-body">
                    <div class="row">
                        <div class="col-1">
                        </div>
                    ...
                    <div class="card mb-2">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-1"><span style="color:red;font-weight:bold">{{ $b['status'] }}</span>
                                </div>
                                <div class="col-1">
