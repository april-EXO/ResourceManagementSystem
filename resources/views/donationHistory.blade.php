...
<body>
    ...
    <ul class="nav nav-pills nav-fill mx-5 mt-5">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="/donation-history">Donation History</a>
        </li>
    </ul>
                ...
                <div class="card-body" style="background-color: rgb(243, 246, 250)">
                    <div class="row">
                        ...
                        <div class="col-1">
                            ...
                            @if ($donationRecord->status == 'success')
                                <h6 style="color:rgb(30, 157, 42);font-weight:bold">{{ $donationRecord->status }}</h6>
                            @else
                                <h6 style="color:rgb(177, 18, 58);font-weight:bold">{{ $donationRecord->status }}</h6>
                            @endif
                        ...
                        <div class="modal fade" id="exampleModal-{{ $key }}" data-bs-backdrop="static"
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    @if($donationRecord->status=="failed")
                                    <div class="row mt-5">
                                        <form name="received" id="received"
                                            action={{ url('/donation/receivedSuccess') }} method="POST">
                                            @csrf
