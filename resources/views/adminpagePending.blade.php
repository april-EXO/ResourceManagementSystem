    ...
    <div class="card">
        <div class="card-body">
            ...
            <ul class="nav nav-pills mb-5">
                <li class="nav-item">
                  <a class="nav-link active" aria-current="page" href="/admin/pending">Pending</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="/admin/rejected">Rejected</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="/admin/success">Success</a>
                </li>
              </ul>

              <h6 class="mb-3" style="color: rgb(190, 129, 17)">
                *Applications pending for review.
            </h6>
              
            <div class="card" style="background-color:rgb(248, 209, 136)">
                <div class="card-body">
                    <div class="row">
                        <div class="col-1">
                        </div>
                    ...
                    <div class="card mb-2">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-1"><span style="color:orange;font-weight:bold">{{ $b['status'] }}</span>
                                </div>
                                <div class="col-1">
