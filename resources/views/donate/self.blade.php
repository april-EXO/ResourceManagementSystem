		...
		<div class="p-5">
			<div class="card">
				<div class="card-body">
					...
					<p class="card-text">手动寄出物品并且填写寄件单号。<br>Send the resources to the address below and fill in the tracking number.<br>
					</p>
					<br><br>
					<p class="card-text">
					<div class="card mb-3">
	...
	<div class="p-5">
		<form action="/form/beneficiary" method="POST" class="formContainer">
			...
			<div class="form-floating mb-3">
				...
				<label for="deliverdetail">派送详情 Delivery detail: （Deliver date/Tracking number and courier name/ other remark) </label>
			</div>
			<div class="row">
				<div class="col">
